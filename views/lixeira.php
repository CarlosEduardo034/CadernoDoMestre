...
<a href="/CadernoDoMestre00/Dashboard/Dashboard.php">Voltar</a>
...
<script>
    ...
    function carregarLixeira() {    
        fetch(`${BASE_URL}/api/lixeira/listar.php`)
        .then(res => res.json())
        .then(itens => {
    ...
    function restaurar(id, tipo) {
        const url = tipo === "capitulo"
            ? `${BASE_URL}/api/capitulos/restaurar.php`
            : `${BASE_URL}/api/paginas/restaurar.php`;
    ...
    function excluirDefinitivo(id, tipo) {
        ...
        const url = tipo === "capitulo"
            ? `${BASE_URL}/api/capitulos/deletar.php`
            : `${BASE_URL}/api/paginas/deletar.php`;
